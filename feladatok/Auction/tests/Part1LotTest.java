...
public class Part1LotTest extends Testable {
	...
	public void assertion() {
		...
		check("getHammerPrice(): a metodus nem a helyes leutesi arat adja vissza, ha nem tortent licitalas.",
				l1.getHammerPrice() == 400000);
		...
		check("toString(): a metodus nem a helyes szoveges reprezentaciot adja vissza. (szerzo)",
				s.contains("Salvador Dali"));

		check("toString(): a metodus nem a helyes szoveges reprezentaciot adja vissza. (cim)",
				s.contains("PORTRAIT DE MADAME DUCAS"));
		check("toString(): a metodus nem a helyes szoveges reprezentaciot adja vissza. (ar)",
				s.contains((price + 1) + " GBP"));
		...
		check("moreExpensiveThan(): igazat ad vissza, amikor a parameter mutargy ugyanannyiba kerul.",
				!l2.moreExpensiveThan(l1));
	}
	...
	public Object[] expectedMethods() throws Exception {
		return new Object[] { staticMethod(Lot.class, className() + ".make", String.class, String.class, Integer.TYPE),
				method(String.class, className() + ".getArtist"), method(String.class, className() + ".getTitle"),
				method(Integer.TYPE, className() + ".getHammerPrice"),
				method(Boolean.TYPE, className() + ".moreExpensiveThan", Lot.class),
				method(Void.TYPE, className() + ".bid", Integer.TYPE), method(String.class, className() + ".toString") };
	}
